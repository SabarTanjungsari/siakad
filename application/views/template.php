	...
	<div id="wrapper">
		...
		<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>">
				...
				<div class="sidebar-brand-text mx-3">SI <sup>Sekolah</sup></div>
			</a>
			...
			<?php foreach ($this->session->userdata('menus') as $menu) { ?>
				<li class="nav-item">
					...
					<div id="id<?= $menu->menu_id ?>" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
